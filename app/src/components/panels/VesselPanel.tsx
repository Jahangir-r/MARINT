...
export default function VesselPanel() {
  ...
  return (
    <aside className="w-[380px] shrink-0 border-l border-hairline bg-surface-1 flex flex-col overflow-hidden">
      {/* Header */}
      ...
      {/* Hero */}
      <div className="h-44 shrink-0 bg-surface-2 border-b border-hairline relative overflow-hidden">
        {vessel.image ? (
          <>
            <img
