...
export default function Timeline() {
  ...
  return (
    <div
      className="absolute left-3 right-20 bottom-3 z-10 bg-surface-1/95 border border-hairline rounded-xl px-3.5 py-3 flex flex-wrap items-center gap-x-3 gap-y-2"
